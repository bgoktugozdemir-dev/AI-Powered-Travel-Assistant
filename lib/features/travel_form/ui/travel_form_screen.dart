...
class _TravelFormScreenState extends State<TravelFormScreen> {
  ...
  void initState() {
    ...
    // Listen to BLoC state changes to update TextEditingController if needed
    // For example, when an airport is selected, update the text field.
          ...
          body: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                // TODO: Add widgets for other steps (1 to 4)
