...
class CountryService {
  static const String _countryApiUrl = 'https://raw.githubusercontent.com/Imagin-io/country-nationality-list/refs/heads/master/countries.json';
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _countries = jsonData.map((item) => Country(
